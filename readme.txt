...
Bjorn is a functional and responsive multi-purpose theme that is the perfect solution for your business’s online presence.
...
The demo site URL: http://bjorndemo.wordpress.com/?demo

When you first activate Bjorn, you’ll see your posts in a traditional blog format. If you’d like to use this template as the front page of your site, follow these instructions:
...
Bjorn comes packed with multiple Theme Options available via the Customizer:
...
Bjorn allows you to display links to your social media profiles — like Twitter and Facebook — as icons using a Custom Menu.
...
Once your menu is created and your social links are added, you can display it in your Footer Menu. You can also create a new Custom Menu Widget to display it in any of Bjorn‘s widget areas as seen on the demo site.

Bjorn will automatically display an icon for each service if it’s available.
...
Bjorn offers seven widget areas, which can be configured in Appearance → Widgets:
...
Bjorn comes with two special CSS styles, button and button-minimal. You can add these classes to your links in the Text Editor, to create “call to action” buttons.

For example:

<a href="http://bjorndemo.wordpress.com/" class="button">Button</a>

<a href="http://bjorndemo.wordpress.com/" class="button-minimal">Button Minimal</a>
